                ...
                <div className="row justify-content-center">
                    <div className="col-lg-7">
                        <div className="Login-form">
                            <h2 className="brand-color fw-bold text-center mt-5 mb-3 login-heading">Login</h2>
                            ...
                            <p className="mt-4 fw-bold">New to Comfort Car Palace then please <Link to="/register">Create an account</Link> or go to <Link style={{fontSize:"22px",textDecoration:"none"}} to="/home">Home</Link></p>
                        </div>
                    </div>
                </div>
            </div>
